...
\begin{itemize}
  ...
  \item[] Instructor, CS343: Operating Systems~(F20,S22,F22)
    ...
    \end{itemize}
  \item[] Instructor, CE346: Microprocessor System Design~(S21,F21,F22,F23)
    \vspace{-\topsep}
    \vspace{\itemsep}
    \begin{itemize}
...
\vspace{-6pt}
\begin{itemize}
  \item[] Erdős Number: 4\\(Branden Ghena - Alex Halderman - Paul Zimmerman - Peter Montgomery - Paul Erdős)
\end{itemize}
