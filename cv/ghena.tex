...
\begin{tabularx}{\linewidth}{@{} X r @{}}
    ...
    {University of California, Berkeley}   & {Cell:~+1.734.7555.6653} \\
...
\begin{itemize}
  ...
  \item[] Graduate Student Instructor, EE 149: Introduction to Embedded Systems~(Fall 2018)
    ...
    \vspace{\itemsep}
    \begin{itemize}
      \item Topics include embedded software, sensors, and modeling cyber-physical systems.
    ...
    simplified code development with Git, GCC, and Makefiles and a custom
    hardware platform, Buckler, built upon the nRF52832 dev kit.
