...
\begin{itemize}
  ...
  \item[] Instructor, CS213: Introduction to Computer Systems~(F20,S21,W22,W23,F23,W24,W25,W26)
    ...
    \end{itemize}
  \item[] Instructor, CS343: Operating Systems~(F20,S22,F22,S24,F24,F25)
    \vspace{-\topsep}
    \vspace{\itemsep}
    \begin{itemize}
      \item Topics: concurrency, scheduling, virtual memory, and file systems. 80--150 students.
    \end{itemize}
  \item[] Instructor, CE346/CS346: Microcontroller System Design~(S21,F21,F22,F23,F24,S25,F25,S26)
    \vspace{-\topsep}
    \vspace{\itemsep}
    \begin{itemize}
